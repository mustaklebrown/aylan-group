        ...
        <div className="container mx-auto px-4 md:px-8">
          {blogs.length === 0 ? (
            <div className="text-center py-20 glass-panel rounded-[2.5rem] border border-white/10">
              <p className="text-text-muted text-lg">Aucun article de blog n'a été publié pour le moment.</p>
            </div>
          ) : (
          ...
          <div className="mt-24 glass-panel p-12 md:p-20 rounded-[4rem] border border-white/10 text-center relative overflow-hidden">
            <div className="relative z-10 max-w-2xl mx-auto">
              ...
              <form className="flex flex-col md:flex-row gap-4 max-w-lg mx-auto">
                ...
                />
                <button className="btn btn-primary px-10 py-4 whitespace-nowrap" type="button">
                  S'abonner
                </button>
              </form>
            </div>
